...
parser = argparse.ArgumentParser(description='train SHKD student network.')
...
exp_name = 'shkd_student_{}_weight{}+{}+{}+{}_T{}+{}+{}_ratio{}+{}_seed{}_{}'.format(\
            args.s_arch, \
...
for epoch in range(args.t_epoch):
    ...
    for x, target in train_loader:
        ...
        x, targets_a, targets_b, lam = mixup_data(x.cuda(), target.cuda(), alpha=1.0)
